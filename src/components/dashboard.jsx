  ...
  return (
    <div className="flex-1 bg-gray-100">
      <div className="grid grid-cols-2 gap-8 p-8 ">
        ...
        <div className="bg-gray-300 p-4 rounded-md shadow-md h-[480px]  hover:ring-4   hover:bg-slate-400  hover:ring-slate-800 hover:ring-opacity-50 hover:ring-offset-2 ">
